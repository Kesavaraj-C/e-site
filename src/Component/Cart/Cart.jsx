      ...
      <div className="cart-body">
        <div className="cart-navbar">
          <div className="cart-navbar-left">
            ...
            <input
              type="text"
              className="cart-search searchbar-outerlayer"
              ...
              return (
                <div className="cart-items-selected" key={x.id}>
                  ...
                  <div className="cart-items-selected-details">
                    ...
                    <p className="cisdprjice">$ {x.price} </p>
                    <div className="cart-items-selected-ratings-h">
                      <h3>Ratings</h3>
                    ...
                    <div className="cart-itemsBuydiv">
                      <button className="cibIncrement">+</button>
                      <button className="cibBuy">Buy now</button>
                      <button className="cibDecrement">-</button>
                    </div>
                  </div>
                </div>
              );
